...
from personal_cabinet.handlers import personal_cabinet_router
from help_section.handlers import help_section_router


def register_routers(dispatcher: Dispatcher):
    dispatcher.include_router(personal_cabinet_router)
    dispatcher.include_router(content_section_router)
    dispatcher.include_router(help_section_router)
